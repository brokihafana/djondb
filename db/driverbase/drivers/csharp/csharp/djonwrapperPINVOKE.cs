...
class djonwrapperPINVOKE {
  ...
  [DllImport("djonwrapper", EntryPoint="CSharp_new_DjondbCursor__SWIG_0")]
  public static extern IntPtr new_DjondbCursor__SWIG_0(HandleRef jarg1, HandleRef jarg2, HandleRef jarg3, string jarg4, HandleRef jarg5);

  [DllImport("djonwrapper", EntryPoint="CSharp_new_DjondbCursor__SWIG_1")]
  public static extern IntPtr new_DjondbCursor__SWIG_1(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_delete_DjondbCursor")]
  public static extern void delete_DjondbCursor(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_next")]
  public static extern bool DjondbCursor_next(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_previous")]
  public static extern bool DjondbCursor_previous(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_current")]
  public static extern IntPtr DjondbCursor_current(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_length")]
  public static extern int DjondbCursor_length(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_releaseCursor")]
  public static extern void DjondbCursor_releaseCursor(HandleRef jarg1);

  [DllImport("djonwrapper", EntryPoint="CSharp_DjondbCursor_seek")]
  public static extern void DjondbCursor_seek(HandleRef jarg1, int jarg2);
